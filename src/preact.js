/* esm.sh - esbuild bundle(htm@3.1.1/preact/standalone) es2022 production */
var N,
  f,
  en,
  D,
...
function ln(e, n, t) {
  var _,
    ...
    u = {};
  for (r in n)
    r == "key" ? (_ = n[r]) : r == "ref" ? (l = n[r]) : (u[r] = n[r]);
  if (
    (arguments.length > 2 &&
      (u.children = arguments.length > 3 ? N.call(arguments, 2) : t),
...
function R(e) {
  ((!e.__d && (e.__d = !0) && D.push(e) && !L.__r++) ||
    B !== f.debounceRendering) &&
    ((B = f.debounceRendering) || tn)(L);
}
function L() {
  for (var e; (L.__r = D.length); )
    (e = D.sort(function (n, t) {
...
function cn(e, n, t, _, l, r, u, a, s, h) {
  ...
  for (t.__k = [], o = 0; o < n.length; o++)
    if (
      (i = t.__k[o] =
        (i = n[o]) == null || typeof i == "boolean"
          ? null
          : typeof i == "string" || typeof i == "number" || typeof i == "bigint"
          ? U(null, i, null, null, i)
          : Array.isArray(i)
          ? U(W, { children: i }, null, null, null)
          : i.__b > 0
          ? U(i.type, i.props, i.key, null, i.__v)
          : i) != null
    ) {
      if (
        ((i.__ = t),
        (i.__b = t.__b + 1),
        (c = y[o]) === null || (c && i.key == c.key && i.type === c.type))
      )
        y[o] = void 0;
      else
        for (m = 0; m < k; m++) {
      ...
      V(e, i, (c = c || F), l, r, u, a, s, h),
        ...
        p != null
          ? (b == null && (b = p),
            typeof i.type == "function" && i.__k != null && i.__k === c.__k
              ? (i.__d = s = sn(i, s, e))
              : (s = fn(e, i, c, y, p, s)),
            h || t.type !== "option"
              ? typeof t.type == "function" && (t.__d = s)
              : (e.value = ""))
          : s && c.__e == s && s.parentNode != e && (s = E(c));
    }
  for (t.__e = b, o = k; o--; )
    y[o] != null &&
      (typeof t.type == "function" &&
        ...
        (t.__d = E(_, o + 1)),
      hn(y[o], y[o]));
  if (v) for (o = 0; o < v.length; o++) pn(v[o], v[++o], v[++o]);
}
function sn(e, n, t) {
  var _, l;
    ...
    (l = e.__k[_]) &&
      ...
      (n =
        typeof l.type == "function"
          ? sn(l, n, t)
          : fn(t, l, l, e.__k, l.__e, n)));
  return n;
}
function fn(e, n, t, _, l, r) {
  var u, a, s;
  if (n.__d !== void 0) (u = n.__d), (n.__d = void 0);
  else if (t == null || l != r || l.parentNode == null)
    n: if (r == null || r.parentNode !== e) e.appendChild(l), (u = null);
    else {
      for (a = r, s = 0; (a = a.nextSibling) && s < _.length; s += 2)
        if (a == l) break n;
...
function $(e, n, t) {
  n[0] === "-"
    ? e.setProperty(n, t)
    : (e[n] =
        t == null ? "" : typeof t != "number" || yn.test(n) ? t : t + "px");
}
function T(e, n, t, _, l) {
  ...
  n: if (n === "style")
    if (typeof t == "string") e.style.cssText = t;
      ...
      if (t) for (n in t) (_ && t[n] === _[n]) || $(e.style, n, t[n]);
    }
  else if (n[0] === "o" && n[1] === "n")
    (r = n !== (n = n.replace(/Capture$/, ""))),
      ...
      (e.l[n + r] = t),
      t
        ? _ || e.addEventListener(n, r ? G : j, r)
        : e.removeEventListener(n, r ? G : j, r);
...
function V(e, n, t, _, l, r, u, a, s) {
  ...
  t.__h != null &&
    ((s = t.__h), (a = n.__e = t.__e), (n.__h = null), (r = [a])),
    (h = f.__b) && h(n);
  try {
    n: if (typeof d == "function") {
      if (
        ((v = n.props),
        (y = (h = d.contextType) && _[h.__c]),
        (k = h ? (y ? y.props.value : h.__) : _),
        t.__c
          ? (b = (o = n.__c = t.__c).__ = o.__E)
        ...
        d.getDerivedStateFromProps != null &&
          (o.__s == o.state && (o.__s = C({}, o.__s)),
          C(o.__s, d.getDerivedStateFromProps(v, o.__s))),
        (c = o.props),
        (i = o.state),
        m)
      )
      ...
      (o.context = k),
        ...
        (o.state = o.__s),
        o.getChildContext != null && (_ = C(C({}, _), o.getChildContext())),
        m ||
          o.getSnapshotBeforeUpdate == null ||
          (p = o.getSnapshotBeforeUpdate(c, i)),
        (H = h != null && h.type === W && h.key == null ? h.props.children : h),
        cn(e, Array.isArray(H) ? H : [H], n, t, _, l, r, u, a, s),
        (o.base = n.__e),
        (n.__h = null),
        o.__h.length && u.push(o),
        b && (o.__E = o.__ = null),
...
function gn(e, n, t, _, l, r, u, a) {
  ...
  if (i === null) m === c || (a && e.data === c) || (e.data = c);
    ...
    if (
      ((r = r && N.call(e.childNodes)),
      (h = (m = t.props || F).dangerouslySetInnerHTML),
      (o = c.dangerouslySetInnerHTML),
      !a)
    ) {
      if (r != null)
      ...
      (o || h) &&
        ((o && ((h && o.__html == h.__html) || o.__html === e.innerHTML)) ||
    ...
    if (
      ((function (b, v, y, k, H) {
        var d;
        for (d in y)
          d === "children" || d === "key" || d in v || T(b, d, null, y[d], k);
        for (d in v)
          (H && typeof v[d] != "function") ||
            d === "children" ||
            d === "key" ||
            d === "value" ||
            d === "checked" ||
    ...
    a ||
      ("value" in c &&
        (p = c.value) !== void 0 &&
        (p !== e.value || (i === "progress" && !p)) &&
        T(e, "value", p, m.value, !1),
      "checked" in c &&
        (p = c.checked) !== void 0 &&
        p !== e.checked &&
        T(e, "checked", p, m.checked, !1));
  }
  return e;
}
function pn(e, n, t) {
...
function hn(e, n, t) {
  ...
  if (
    ...
    (_ = e.ref) && ((_.current && _.current !== e.__e) || pn(_, null, n)),
    (_ = e.__c) != null)
  ) {
  ...
  if ((_ = e.__k))
    for (l = 0; l < _.length; l++)
      _[l] && hn(_[l], n, typeof e.type != "function");
...
function En(e, n, t) {
  var _, l, r;
  f.__ && f.__(e, n),
    (l = (_ = typeof t == "function") ? null : (t && t.__k) || n.__k),
    (r = []),
    V(
      n,
      (e = ((!_ && t) || n).__k = ln(W, null, [e])),
      l || F,
      F,
      n.ownerSVGElement !== void 0,
      !_ && t ? [t] : l ? null : n.firstChild ? N.call(n.childNodes) : null,
      r,
      !_ && t ? t : l ? l.__e : n.firstChild,
      _
    ),
    an(r, e);
}
...
(N = rn.slice),
          ...
          try {
            if (
              ((_ = t.constructor) &&
                ...
                (t.setState(_.getDerivedStateFromError(e)), (l = t.__d)),
              t.componentDidCatch != null &&
                (t.componentDidCatch(e), (l = t.__d)),
              l)
            )
              return (t.__E = t);
          } catch (r) {
  ...
  (A.prototype.setState = function (e, n) {
    ...
    (t =
      ...
      e && C(t, e),
      e != null && this.__v && (n && this.__h.push(n), R(this));
  }),
  (A.prototype.forceUpdate = function (e) {
    this.__v && ((this.__e = !0), e && this.__h.push(e), R(this));
  }),
  (A.prototype.render = W),
  (D = []),
  (tn =
...
function Un(e) {
  ...
  return (
    (t.c = e),
    n ? (t.__ == null && ((t.__ = !0), n.sub(g)), n.props.value) : e.__
  );
}
function An(e, n) {
...
function Mn(e) {
  ...
  return (
    (n.__ = e),
    g.componentDidCatch ||
      (g.componentDidCatch = function (_) {
        n.__ && n.__(_), t[1](_);
      }),
    [
      t[0],
...
(f.__b = function (e) {
  ...
  (f.diffed = function (e) {
    ...
    n &&
      n.__H &&
      n.__H.__h.length &&
      ((I.push(n) !== 1 && z === f.requestAnimationFrame) ||
        (
          (z = f.requestAnimationFrame) ||
          function (t) {
            var _,
              l = function () {
...
var mn = function (e, n, t, _) {
    ...
    for (var r = 1; r < n.length; r++) {
      ...
      u === 3
        ? (_[0] = a)
        : u === 4
        ? (_[1] = Object.assign(_[1] || {}, a))
        : u === 5
        ? ((_[1] = _[1] || {})[n[++r]] = a)
        : u === 6
        ? (_[1][n[++r]] += a + "")
        : u
        ? ((l = e.apply(a, mn(e, a, t, ["", null]))),
          _.push(l),
          a[0] ? (n[0] |= 2) : ((n[r - 2] = 0), (n[r] = l)))
        : _.push(a);
    }
    return _;
  },
...
export {
  ...
  An as useDebugValue,
  Pn as useEffect,
  Mn as useErrorBoundary,
  wn as useImperativeHandle,
  xn as useLayoutEffect,
  dn as useMemo,
  Cn as useReducer,
  Dn as useRef,
  bn as useState,
